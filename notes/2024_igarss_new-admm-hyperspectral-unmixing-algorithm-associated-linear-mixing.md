...
- **Venue**: IEEE IGARSS
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/IGARSS53475.2024.10640925
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/A New ADMM-Based Hyperspectral Unmixing Algorithm Associated with a Linear Mixing Model Addressing Spectral Variability with a Multiplicative Structure.pdf
- **Datasets**: synthetic
...
- **What it is about**: This paper studies ADMM, spectral variability for hyperspectral unmixing, centered on "A New ADMM-Based Hyperspectral Unmixing Algorithm Associated with a Linear Mixing Model Addressing Spectral Variability with a Multiplicative Structure".
...
```bibtex
@article{new_admm_hyperspectral_unmixing_algorithm_associated_linear_mixing,
  ...
  author={TBD},
  year={2024},
  doi={10.1109/IGARSS53475.2024.10640925}
}
```
