...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/LGRS.2023.3345959
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Deep Attention-Guided Spatial-Spectral Network for Hyperspectral Image Unmixing.pdf
- **Datasets**: Samson; Jasper Ridge
- **Tags**: linear,blind,autoencoder,attention
- **Note status**: skimmed from the local PDF metadata and abstract

## One-Sentence Summary

This skim note records a linear blind unmixing, autoencoder, attention paper and tracks its reported evaluation on Samson; Jasper Ridge.
...
- Main idea: linear blind unmixing; autoencoder; attention.
