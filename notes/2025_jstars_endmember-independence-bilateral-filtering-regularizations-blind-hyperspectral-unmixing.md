...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2025.3605626
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Endmember Independence and Bilateral Filtering Regularizations for Blind Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,tensor
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies tensor for hyperspectral unmixing, centered on "Endmember Independence and Bilateral Filtering Regularizations for Blind Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, tensor paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; tensor.
...
```bibtex
@article{endmember_independence_bilateral_filtering_regularizations_blind_hyperspectral_unmixing,
  title={Endmember Independence and Bilateral Filtering Regularizations for Blind Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/JSTARS.2025.3605626}
}
```
