...
- **作者**：Shu Xiang; Xiaorun Li; Jigang Ding; Shuhan Chen; Ziqiang Hua
- **论文**：https://doi.org/10.1109/TGRS.2024.3375598
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/Unidirectional_Local-Attention_Autoencoder_Network_for_Spectral_Variability_Unmixing.pdf
- **数据集**：synthetic; real datasets
- **标签**：linear,blind,spectral-variability,autoencoder,attention
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; 光谱变异; local-注意力 自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
...
这是一篇关于线性盲解混; 光谱变异; local-注意力 自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
...
- 核心思路：线性盲解混; 光谱变异; local-注意力 自编码器。
