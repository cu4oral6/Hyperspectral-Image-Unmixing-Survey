...
- **这篇论文讲了什么**：这是一篇关于线性盲解混; 光谱变异; local-注意力 自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; 真实数据集。
...
这是一篇关于线性盲解混; 光谱变异; local-注意力 自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; 真实数据集。
