...
- **作者**：TBD
- **论文**：https://doi.org/10.1109/TGRS.2024.3354046
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/A Novel Endmember Bundle Extraction Framework for Capturing Endmember Variability by Dynamic Optimization.pdf
- **数据集**：Urban
...
- **用了哪些数据集**：Urban。
- **实验效果怎么样**：在 Urban 上，实验与解混基线比较，并报告重构、丰度或端元估计有所改善，评价指标包括 Mean SAD/SAD/RMSE/MSE。
