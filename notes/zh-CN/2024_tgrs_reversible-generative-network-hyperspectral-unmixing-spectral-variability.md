...
- **作者**：TBD
- **论文**：https://doi.org/10.1109/TGRS.2024.3403926
- **代码**：https://github.com/Lab-PANbin/Rev-Net
- **项目页**：TBD
- **本地 PDF**：../../pdfs/A Reversible Generative Network for Hyperspectral Unmixing With Spectral Variability.pdf
- **数据集**：synthetic
- **标签**：linear,blind,attention
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; 光谱变异; 注意力的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
...
这是一篇关于线性盲解混; 光谱变异; 注意力的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
...
```bibtex
@article{reversible_generative_network_hyperspectral_unmixing_spectral_variability,
