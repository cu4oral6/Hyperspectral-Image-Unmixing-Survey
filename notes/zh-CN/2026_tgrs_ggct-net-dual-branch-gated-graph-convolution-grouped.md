...
- **这篇论文讲了什么**：这是一篇关于线性盲解混; Transformer; 图正则; 注意力的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 论文报告的数据集。
...
这是一篇关于线性盲解混; Transformer; 图正则; 注意力的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 论文报告的数据集。
