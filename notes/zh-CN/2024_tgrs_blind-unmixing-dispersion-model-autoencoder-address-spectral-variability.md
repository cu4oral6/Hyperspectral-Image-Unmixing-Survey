...
- **作者**：Haoren Zheng; Zulong Li; Chenyu Sun; Hanqiu Zhang; Hongyi Liu; Zhihui Wei
- **论文**：https://doi.org/10.1109/TGRS.2024.3399003
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/Blind_Unmixing_Using_Dispersion_Model-Based_Autoencoder_to_Address_Spectral_Variability.pdf
- **数据集**：synthetic; real datasets
- **标签**：linear,blind,spectral-variability,dispersion-model,autoencoder
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; 色散模型; 光谱变异; 双流自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
...
这是一篇关于线性盲解混; 色散模型; 光谱变异; 双流自编码器的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
