...
- **作者**：TBD
- **论文**：https://doi.org/10.1109/TGRS.2025.3543566
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/Spectral Variability-Aware Cascaded Autoencoder for Hyperspectral Unmixing.pdf
- **数据集**：synthetic
- **标签**：linear,blind,autoencoder
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; 自编码器; 光谱变异的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
...
这是一篇关于线性盲解混; 自编码器; 光谱变异的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
...
```bibtex
@article{spectral_variability_aware_cascaded_autoencoder_hyperspectral_unmixing,
  title={Spectral Variability-Aware Cascaded Autoencoder for Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/TGRS.2025.3543566}
}
```
