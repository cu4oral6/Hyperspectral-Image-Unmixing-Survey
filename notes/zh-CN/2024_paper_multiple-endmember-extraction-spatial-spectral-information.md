# Multiple Endmember Extraction Using Spatial-Spectral Information
...
- **出版源**：TBD
- **作者**：TBD
- **论文**：https://doi.org/10.1109/SPIC62469.2024.10691535
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/Multiple Endmember Extraction Using Spatial-Spectral Information.pdf
- **数据集**：USGS
- **标签**：linear,blind
...
这是一篇关于线性盲解混; 光谱变异的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 USGS。
...
```bibtex
@article{multiple_endmember_extraction_spatial_spectral_information,
  title={Multiple Endmember Extraction Using Spatial-Spectral Information},
  author={TBD},
  year={2024},
  doi={10.1109/SPIC62469.2024.10691535}
}
```
