...
- **作者**：Pengrui Wang; Rong Liu; Liangpei Zhang
- **论文**：https://doi.org/10.1109/TGRS.2024.3494795
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/MAT-Net_Multiscale_Aggregation_Transformer_Network_for_Hyperspectral_Unmixing.pdf
- **数据集**：synthetic; real datasets
- **标签**：linear,blind,transformer,multiscale,spatial-spectral
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; 多尺度 aggregation Transformer的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
...
这是一篇关于线性盲解混; 多尺度 aggregation Transformer的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic; real datasets。
...
- 核心思路：线性盲解混; 多尺度 aggregation Transformer。
