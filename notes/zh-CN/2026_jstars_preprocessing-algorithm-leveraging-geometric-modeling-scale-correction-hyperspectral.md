...
- **作者**：TBD
- **论文**：https://doi.org/10.1109/JSTARS.2026.3687834
- **代码**：https://github.com/DMUPraveen/Perspecitve_Transform
- **项目页**：TBD
- **本地 PDF**：../../pdfs/Preprocessing Algorithm Leveraging Geometric Modeling for Scale Correction in Hyperspectral Images for Improved Unmixing Performance.pdf
- **数据集**：synthetic
- **标签**：linear,blind,kan,graph
- **笔记状态**：基于本地 PDF 元数据和摘要的速读笔记

## 速读要点

- **这篇论文讲了什么**：这是一篇关于线性盲解混; KAN; 图正则; 光谱变异的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
...
这是一篇关于线性盲解混; KAN; 图正则; 光谱变异的速读笔记，重点记录方法思路、实验设置以及代码线索；相关实验数据集为 synthetic。
