...
- **出版源**：IEEE ICASSP
- **作者**：TBD
- **论文**：https://doi.org/10.1109/ICASSP43922.2022.9747709
- **代码**：TBD
- **项目页**：TBD
- **本地 PDF**：../../pdfs/On the Exclusion of Hyperspectral Sources.pdf
- **数据集**：synthetic
...
- **用了哪些数据集**：synthetic。
- **实验效果怎么样**：在 synthetic 上，实验与解混基线比较，并报告重构、丰度或端元估计有所改善，评价指标包括 SAD/RMSE/MSE/SRE。
