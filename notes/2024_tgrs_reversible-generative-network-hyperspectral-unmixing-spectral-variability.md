...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2024.3403926
- **Code**: https://github.com/Lab-PANbin/Rev-Net
- **Project**: TBD
- **Local PDF**: ../pdfs/A Reversible Generative Network for Hyperspectral Unmixing With Spectral Variability.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,attention
- **Note status**: skimmed from the local PDF metadata and abstract

## One-Sentence Summary

This skim note records a linear blind unmixing, spectral variability, attention paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; spectral variability; attention.
