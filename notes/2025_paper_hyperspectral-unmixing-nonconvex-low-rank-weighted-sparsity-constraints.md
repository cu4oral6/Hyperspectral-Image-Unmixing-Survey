...
- **Datasets**: Jasper Ridge; USGS synthetic; synthetic
...
- **Experimental effect**: On Jasper Ridge; USGS synthetic; synthetic, reports competitive or second-best performance against recent baselines (SAD/RMSE).
