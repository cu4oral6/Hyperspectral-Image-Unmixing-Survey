# Transformer-Enhanced CNN Based on Intensive Feature for Hyperspectral Unmixing
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/LGRS.2024.3485899
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Transformer-Enhanced CNN Based on Intensive Feature for Hyperspectral Unmixing.pdf
- **Datasets**: Samson; Urban; synthetic
- **Tags**: linear,blind,autoencoder,transformer,sparse,gan
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies autoencoder, transformer, sparse, GAN for hyperspectral unmixing, centered on "Transformer-Enhanced CNN Based on Intensive Feature for Hyperspectral Unmixing".
...
- **Datasets used**: Samson; Urban; synthetic.
- **Experimental effect**: On Samson; Urban; synthetic, reports best or stronger overall abundance/endmember estimation than the compared baselines (SAD/RMSE).

## One-Sentence Summary

This skim note records a linear blind unmixing, autoencoder, transformer, sparse, GAN paper and tracks its reported evaluation on Samson; Urban; synthetic.
...
- Main idea: linear blind unmixing; autoencoder; transformer; sparse; GAN.
...
```bibtex
@article{transformer_enhanced_cnn_intensive_feature_hyperspectral_unmixing,
