# Combinatorial Nonnegative Matrix-Tensor Factorization for Hyperspectral Unmixing Using a General lq Norm Regularization
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2024.3392497
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Combinatorial Nonnegative Matrix-Tensor Factorization for Hyperspectral Unmixing Using a General --ell _-q-- Norm Regularization.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,nmf,sparse,tensor,attention
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies NMF, sparse, tensor, attention for hyperspectral unmixing, centered on "Combinatorial Nonnegative Matrix-Tensor Factorization for Hyperspectral Unmixing Using a General lq Norm Regularization".
...
This skim note records a linear blind unmixing, NMF, sparse, tensor, attention paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; NMF; sparse; tensor; attention.
...
```bibtex
@article{combinatorial_nonnegative_matrix_tensor_factorization_hyperspectral_unmixing_general,
  title={Combinatorial Nonnegative Matrix-Tensor Factorization for Hyperspectral Unmixing Using a General lq Norm Regularization},
  author={TBD},
  year={2024},
