...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2024.3392833
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Hyperspectral Unmixing Using Reweighted Unidirectional TV Low-Rank NTF With Multiple-Factor Collaboration Regularization.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,sparse,tensor
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies sparse, low-rank, tensor for hyperspectral unmixing, centered on "Hyperspectral Unmixing Using Reweighted Unidirectional TV Low-Rank NTF With Multiple-Factor Collaboration Regularization".
...
This skim note records a linear blind unmixing, sparse, low-rank, tensor paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; sparse; low-rank; tensor.
...
```bibtex
@article{hyperspectral_unmixing_reweighted_unidirectional_tv_low_rank_ntf,
  title={Hyperspectral Unmixing Using Reweighted Unidirectional TV Low-Rank NTF With Multiple-Factor Collaboration Regularization},
  author={TBD},
  year={2024},
  doi={10.1109/JSTARS.2024.3392833}
}
```
