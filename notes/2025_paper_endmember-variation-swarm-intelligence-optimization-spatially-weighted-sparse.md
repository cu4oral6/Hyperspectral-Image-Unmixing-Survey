# Endmember Variation via Swarm Intelligence Optimization for Spatially Weighted Sparse Hyperspectral Unmixing
...
- **Venue**: TBD
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/ICVISP68610.2025.11451704
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Endmember Variation via Swarm Intelligence Optimization for Spatially Weighted Sparse Hyperspectral Unmixing.pdf
- **Datasets**: Urban
...
- **What it is about**: This paper studies sparse, ADMM, spectral variability for hyperspectral unmixing, centered on "Endmember Variation via Swarm Intelligence Optimization for Spatially Weighted Sparse Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, sparse, ADMM, spectral variability paper and tracks its reported evaluation on Urban.
...
- Main idea: linear blind unmixing; sparse; ADMM; spectral variability.
...
```bibtex
@article{endmember_variation_swarm_intelligence_optimization_spatially_weighted_sparse,
  title={Endmember Variation via Swarm Intelligence Optimization for Spatially Weighted Sparse Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/ICVISP68610.2025.11451704}
}
```
