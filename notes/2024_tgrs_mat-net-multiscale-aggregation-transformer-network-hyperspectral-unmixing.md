...
- **Authors**: Pengrui Wang; Rong Liu; Liangpei Zhang
- **Paper**: https://doi.org/10.1109/TGRS.2024.3494795
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/MAT-Net_Multiscale_Aggregation_Transformer_Network_for_Hyperspectral_Unmixing.pdf
- **Datasets**: synthetic; real datasets
- **Tags**: linear,blind,transformer,multiscale,spatial-spectral
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies multiscale aggregation transformer for hyperspectral unmixing, centered on "MAT-Net: Multiscale Aggregation Transformer Network for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, multiscale aggregation transformer paper and tracks its reported evaluation on synthetic; real datasets.
...
- Main idea: linear blind unmixing; multiscale aggregation transformer.
...
```bibtex
@article{mat_net_multiscale_aggregation_transformer_network_hyperspectral_unmixing,
  title={MAT-Net: Multiscale Aggregation Transformer Network for Hyperspectral Unmixing},
  author={Pengrui Wang; Rong Liu; Liangpei Zhang},
  year={2024},
