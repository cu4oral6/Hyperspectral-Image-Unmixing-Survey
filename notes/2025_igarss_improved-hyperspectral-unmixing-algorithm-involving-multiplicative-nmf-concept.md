# Improved Hyperspectral Unmixing Algorithm Involving the Multiplicative NMF Concept for Additive Mixing Model Dealing with Spectral Variability
...
- **Venue**: IEEE IGARSS
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/IGARSS55030.2025.11243233
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Improved Hyperspectral Unmixing Algorithm Involving the Multiplicative NMF Concept for Additive Mixing Model Dealing with Spectral Variability.pdf
- **Datasets**: synthetic
...
- **What it is about**: This paper studies NMF, spectral variability for hyperspectral unmixing, centered on "Improved Hyperspectral Unmixing Algorithm Involving the Multiplicative NMF Concept for Additive Mixing Model Dealing with Spectral Variability".
...
This skim note records a linear blind unmixing, NMF, spectral variability paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; NMF; spectral variability.
...
```bibtex
@article{improved_hyperspectral_unmixing_algorithm_involving_multiplicative_nmf_concept,
  title={Improved Hyperspectral Unmixing Algorithm Involving the Multiplicative NMF Concept for Additive Mixing Model Dealing with Spectral Variability},
  author={TBD},
  year={2025},
  doi={10.1109/IGARSS55030.2025.11243233}
}
```
