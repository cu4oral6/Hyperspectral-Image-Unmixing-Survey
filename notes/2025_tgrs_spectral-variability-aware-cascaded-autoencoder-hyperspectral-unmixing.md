...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2025.3543566
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Spectral Variability-Aware Cascaded Autoencoder for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
...
This skim note records a linear blind unmixing, autoencoder, spectral variability paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; autoencoder; spectral variability.
