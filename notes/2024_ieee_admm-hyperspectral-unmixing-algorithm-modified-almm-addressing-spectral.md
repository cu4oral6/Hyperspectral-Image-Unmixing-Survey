# An Admm-Based Hyperspectral Unmixing Algorithm For A Modified Almm Addressing Spectral Variability
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/M2GARSS57310.2024.10537333
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/An Admm-Based Hyperspectral Unmixing Algorithm For A Modified Almm Addressing Spectral Variability.pdf
- **Datasets**: synthetic
...
- **What it is about**: This paper studies NMF, ADMM, spectral variability for hyperspectral unmixing, centered on "An Admm-Based Hyperspectral Unmixing Algorithm For A Modified Almm Addressing Spectral Variability".
...
This skim note records a linear blind unmixing, NMF, ADMM, spectral variability paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; NMF; ADMM; spectral variability.
...
```bibtex
@article{admm_hyperspectral_unmixing_algorithm_modified_almm_addressing_spectral,
  title={An Admm-Based Hyperspectral Unmixing Algorithm For A Modified Almm Addressing Spectral Variability},
  author={TBD},
  year={2024},
  doi={10.1109/M2GARSS57310.2024.10537333}
}
```
