# Mamba-Enhanced Spatial-Spectral Feature Learning for Hyperspectral Unmixing
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2025.3598873
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Mamba-Enhanced Spatial-Spectral Feature Learning for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
...
- **What it is about**: This paper studies Mamba for hyperspectral unmixing, centered on "Mamba-Enhanced Spatial-Spectral Feature Learning for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, Mamba paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; Mamba.
...
```bibtex
@article{mamba_enhanced_spatial_spectral_feature_learning_hyperspectral_unmixing,
  title={Mamba-Enhanced Spatial-Spectral Feature Learning for Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/JSTARS.2025.3598873}
}
```
