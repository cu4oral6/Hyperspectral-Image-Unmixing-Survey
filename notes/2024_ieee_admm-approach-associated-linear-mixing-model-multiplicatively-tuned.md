...
- **Year**: 2024
- **Venue**: IEEE Mediterranean and Middle-East Geoscience and Remote Sensing Symposium
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/M2GARSS57310.2024.10537495
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/An ADMM-Based Approach Associated with a Linear Mixing Model Multiplicatively Tuned to Deal with Spectral Variability in Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,admm
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies ADMM, spectral variability for hyperspectral unmixing, centered on "An ADMM-Based Approach Associated with a Linear Mixing Model Multiplicatively Tuned to Deal with Spectral Variability in Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, ADMM, spectral variability paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; ADMM; spectral variability.
...
```bibtex
@article{admm_approach_associated_linear_mixing_model_multiplicatively_tuned,
  title={An ADMM-Based Approach Associated with a Linear Mixing Model Multiplicatively Tuned to Deal with Spectral Variability in Hyperspectral Unmixing},
  author={TBD},
  year={2024},
  doi={10.1109/M2GARSS57310.2024.10537495}
}
```
