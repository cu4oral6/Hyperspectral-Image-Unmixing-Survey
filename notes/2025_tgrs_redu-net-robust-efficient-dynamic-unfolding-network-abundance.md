...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2025.3540378
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/REDU-Net Robust and Efficient Dynamic Unfolding Network for Abundance Estimation.pdf
...
- **Experimental effect**: On Urban; USGS synthetic, reports best or stronger overall abundance/endmember estimation than the compared baselines (SAD/RMSE/MSE/SRE).
...
- Main idea: linear blind unmixing; GAN; attention; unfolding.
...
```bibtex
@article{redu_net_robust_efficient_dynamic_unfolding_network_abundance,
  title={REDU-Net: Robust and Efficient Dynamic Unfolding Network for Abundance Estimation},
  author={TBD},
  year={2025},
  doi={10.1109/TGRS.2025.3540378}
}
```
