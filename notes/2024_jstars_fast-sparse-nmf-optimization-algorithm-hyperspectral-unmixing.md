...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2023.3341583
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/A Fast Sparse NMF Optimization Algorithm for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,nmf,sparse,attention
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies NMF, sparse, attention for hyperspectral unmixing, centered on "A Fast Sparse NMF Optimization Algorithm for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, NMF, sparse, attention paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; NMF; sparse; attention.
...
```bibtex
@article{fast_sparse_nmf_optimization_algorithm_hyperspectral_unmixing,
  title={A Fast Sparse NMF Optimization Algorithm for Hyperspectral Unmixing},
  author={TBD},
  year={2024},
