# Hyperspectral Unmixing With Row-Sparsity Enhancement: A Difference-of-Convex Approach
...
- **Venue**: TBD
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/APSIPAASC63619.2025.10849210
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Hyperspectral Unmixing With Row-Sparsity Enhancement A Difference-of-Convex Approach.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,kan,sparse,gan
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies KAN, sparse, GAN for hyperspectral unmixing, centered on "Hyperspectral Unmixing With Row-Sparsity Enhancement: A Difference-of-Convex Approach".
...
This skim note records a linear blind unmixing, KAN, sparse, GAN paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; KAN; sparse; GAN.
...
```bibtex
@article{hyperspectral_unmixing_row_sparsity_enhancement_difference_convex_approach,
  title={Hyperspectral Unmixing With Row-Sparsity Enhancement: A Difference-of-Convex Approach},
  author={TBD},
  year={2024},
  doi={10.1109/APSIPAASC63619.2025.10849210}
}
```
