# Physics-Guided Vision Transformer Network With Tokens Complementarity for Hyperspectral Unmixing
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2026.3676520
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Physics-Guided Vision Transformer Network With Tokens Complementarity for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,transformer,tensor
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies transformer, tensor, unfolding for hyperspectral unmixing, centered on "Physics-Guided Vision Transformer Network With Tokens Complementarity for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, transformer, tensor, unfolding paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; transformer; tensor; unfolding.
...
```bibtex
@article{physics_guided_vision_transformer_network_tokens_complementarity_hyperspectral,
  title={Physics-Guided Vision Transformer Network With Tokens Complementarity for Hyperspectral Unmixing},
  author={TBD},
  year={2026},
