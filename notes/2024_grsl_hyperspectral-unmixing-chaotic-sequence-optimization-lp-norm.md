...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/LGRS.2024.3425839
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Hyperspectral Unmixing Based on Chaotic Sequence Optimization of Lp Norm.pdf
- **Datasets**: USGS synthetic
- **Tags**: linear,blind,nmf,sparse
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies NMF, sparse for hyperspectral unmixing, centered on "Hyperspectral Unmixing Based on Chaotic Sequence Optimization of Lp Norm".
...
- **Experimental effect**: On USGS synthetic, reports best or stronger overall abundance/endmember estimation than the compared baselines (SAD/RMSE).

## One-Sentence Summary

This skim note records a linear blind unmixing, NMF, sparse paper and tracks its reported evaluation on USGS.
...
- Main idea: linear blind unmixing; NMF; sparse.
...
```bibtex
@article{hyperspectral_unmixing_chaotic_sequence_optimization_lp_norm,
  title={Hyperspectral Unmixing Based on Chaotic Sequence Optimization of Lp Norm},
  author={TBD},
  year={2024},
  doi={10.1109/LGRS.2024.3425839}
}
```
