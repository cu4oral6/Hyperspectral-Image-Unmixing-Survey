...
- **Venue**: IEEE IGARSS
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/IGARSS53475.2024.10641672
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/A Spectral Variability Attention Autoencoder Network for Hyperspectral Unmixing.pdf
...
- **Experimental effect**: On Samson; Jasper Ridge; Urban, reports best or stronger overall abundance/endmember estimation than the compared baselines (SAD/RMSE).
