...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2025.3605889
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Endmember-Free Hyperspectral Unmixing.pdf
...
- **What it is about**: This paper studies linear blind hyperspectral unmixing for hyperspectral unmixing, centered on "Endmember-Free Hyperspectral Unmixing".
...
- **Experimental effect**: On Urban; synthetic, the paper reports SAD 0.0190 and compares against recent HU baselines.

## One-Sentence Summary

This skim note records a linear blind unmixing paper and tracks its reported evaluation on Urban; synthetic.
...
```bibtex
@article{endmember_free_hyperspectral_unmixing,
  title={Endmember-Free Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/JSTARS.2025.3605889}
}
```
