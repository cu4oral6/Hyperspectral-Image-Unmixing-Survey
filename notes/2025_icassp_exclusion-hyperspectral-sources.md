# On the Exclusion of Hyperspectral Sources
...
- **Venue**: IEEE ICASSP
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/ICASSP43922.2022.9747709
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/On the Exclusion of Hyperspectral Sources.pdf
- **Datasets**: synthetic
...
```bibtex
@article{exclusion_hyperspectral_sources,
