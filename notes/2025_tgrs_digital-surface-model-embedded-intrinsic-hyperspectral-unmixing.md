# Digital Surface Model-Embedded Intrinsic Hyperspectral Unmixing
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2025.3553823
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Digital Surface Model-Embedded Intrinsic Hyperspectral Unmixing.pdf
- **Datasets**: Urban
- **Tags**: linear,blind
...
This skim note records a linear blind unmixing, spectral variability paper and tracks its reported evaluation on Urban.
...
```bibtex
@article{digital_surface_model_embedded_intrinsic_hyperspectral_unmixing,
  title={Digital Surface Model-Embedded Intrinsic Hyperspectral Unmixing},
  author={TBD},
  year={2025},
