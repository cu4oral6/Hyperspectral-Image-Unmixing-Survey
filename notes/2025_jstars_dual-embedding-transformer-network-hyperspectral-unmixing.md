...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2024.3523747
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Dual Embedding Transformer Network for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,autoencoder,transformer,attention,multiscale
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies autoencoder, transformer, attention, multiscale for hyperspectral unmixing, centered on "Dual Embedding Transformer Network for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, autoencoder, transformer, attention, multiscale paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; autoencoder; transformer; attention; multiscale.
...
```bibtex
@article{dual_embedding_transformer_network_hyperspectral_unmixing,
  title={Dual Embedding Transformer Network for Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={10.1109/JSTARS.2024.3523747}
}
```
