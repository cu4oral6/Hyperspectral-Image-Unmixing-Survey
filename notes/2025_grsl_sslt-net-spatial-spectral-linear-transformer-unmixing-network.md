...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/LGRS.2024.3514888
...
This skim note records a linear blind unmixing, transformer, attention, multiscale paper and tracks its reported evaluation on Samson; Jasper Ridge; Apex.
...
```bibtex
@article{sslt_net_spatial_spectral_linear_transformer_unmixing_network,
  title={SSLT-Net: A Spatial-Spectral Linear Transformer Unmixing Network for Hyperspectral Image},
  author={TBD},
  year={2025},
  doi={10.1109/LGRS.2024.3514888}
}
```
