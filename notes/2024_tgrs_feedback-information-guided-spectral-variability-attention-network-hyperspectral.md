# Feedback Information-Guided Spectral Variability Attention Network for Hyperspectral Unmixing
...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TGRS.2024.3452323
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Feedback Information-Guided Spectral Variability Attention Network for Hyperspectral Unmixing.pdf
...
- **What it is about**: This paper studies autoencoder, spectral variability, attention for hyperspectral unmixing, centered on "Feedback Information-Guided Spectral Variability Attention Network for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, autoencoder, spectral variability, attention paper and tracks its reported evaluation on Urban; synthetic.
...
```bibtex
@article{feedback_information_guided_spectral_variability_attention_network_hyperspectral,
  title={Feedback Information-Guided Spectral Variability Attention Network for Hyperspectral Unmixing},
  author={TBD},
  year={2024},
  doi={10.1109/TGRS.2024.3452323}
}
```
