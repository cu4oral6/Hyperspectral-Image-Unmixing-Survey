...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/JSTARS.2024.3368286
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Pixel-to-Abundance Translation Conditional Generative Adversarial Networks Based on Patch Transformer for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,transformer,gan,attention
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies transformer, GAN, attention for hyperspectral unmixing, centered on "Pixel-to-Abundance Translation: Conditional Generative Adversarial Networks Based on Patch Transformer for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, transformer, GAN, attention paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; transformer; GAN; attention.
...
```bibtex
@article{pixel_abundance_translation_conditional_generative_adversarial_networks_patch,
