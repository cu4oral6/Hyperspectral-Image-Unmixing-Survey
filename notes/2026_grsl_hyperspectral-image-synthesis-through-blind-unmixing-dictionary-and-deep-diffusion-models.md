...
- **Datasets**: PRISMA; Urban; synthetic
...
- **Datasets used**: PRISMA; Urban; synthetic.
- **Experimental effect**: PRISMA, Urban and synthetic scenes: evaluates blind-unmixing-based image/abundance synthesis mainly with visual and spectral-consistency comparisons.
