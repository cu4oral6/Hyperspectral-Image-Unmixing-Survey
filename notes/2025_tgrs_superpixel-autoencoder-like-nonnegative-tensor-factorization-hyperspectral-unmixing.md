# Superpixel-Based Autoencoder-Like Nonnegative Tensor Factorization for Hyperspectral Unmixing
...
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Superpixel-Based Autoencoder-Like Nonnegative Tensor Factorization for Hyperspectral Unmixing.pdf
- **Datasets**: synthetic
- **Tags**: linear,blind,autoencoder,nmf,tensor
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies autoencoder, NMF, spectral variability, low-rank for hyperspectral unmixing, centered on "Superpixel-Based Autoencoder-Like Nonnegative Tensor Factorization for Hyperspectral Unmixing".
...
This skim note records a linear blind unmixing, autoencoder, NMF, spectral variability, low-rank paper and tracks its reported evaluation on synthetic.
...
- Main idea: linear blind unmixing; autoencoder; NMF; spectral variability; low-rank.
...
```bibtex
@article{superpixel_autoencoder_like_nonnegative_tensor_factorization_hyperspectral_unmixing,
  title={Superpixel-Based Autoencoder-Like Nonnegative Tensor Factorization for Hyperspectral Unmixing},
  author={TBD},
  year={2025},
  doi={}
}
