# Hyperspectral Unmixing Based on Dual-Graph Manifold Regularization: Joint Preservation of Spatial-Spectral Geometric Structure
...
- **Venue**: TBD
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/ICGMRS66001.2025.11065202
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/Hyperspectral Unmixing Based on Dual-Graph Manifold Regularization Joint Preservation of Spatial-Spectral Geometric Structure.pdf
- **Datasets**: Urban; USGS synthetic; synthetic
- **Tags**: linear,blind,nmf,graph
- **Note status**: skimmed from the local PDF metadata and abstract

## Quick Reading

- **What it is about**: This paper studies NMF, graph for hyperspectral unmixing, centered on "Hyperspectral Unmixing Based on Dual-Graph Manifold Regularization: Joint Preservation of Spatial-Spectral Geometric Structure".
...
- **Datasets used**: Urban; USGS synthetic; synthetic.
- **Experimental effect**: On Urban; USGS synthetic; synthetic, reports best or stronger overall abundance/endmember estimation than the compared baselines (SAD/RMSE).

## One-Sentence Summary

This skim note records a linear blind unmixing, NMF, graph paper and tracks its reported evaluation on Urban; USGS; synthetic.
...
- Main idea: linear blind unmixing; NMF; graph.
...
```bibtex
@article{hyperspectral_unmixing_dual_graph_manifold_regularization_joint_preservation,
  title={Hyperspectral Unmixing Based on Dual-Graph Manifold Regularization: Joint Preservation of Spatial-Spectral Geometric Structure},
  author={TBD},
  year={2025},
  doi={10.1109/ICGMRS66001.2025.11065202}
}
```
