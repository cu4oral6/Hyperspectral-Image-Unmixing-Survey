...
- **Experimental effect**: Evaluated on Urban; USGS synthetic; synthetic with SAD/RMSE; exact result values are not yet extracted in this survey note.
