...
- **Authors**: TBD
- **Paper**: https://doi.org/10.1109/TIP.2025.3638151
- **Code**: TBD
- **Project**: TBD
- **Local PDF**: ../pdfs/URDM Hyperspectral Unmixing Regularized by Diffusion Models.pdf
- **Datasets**: Urban; synthetic
- **Tags**: linear,blind,diffusion,graph,admm
- **Note status**: skimmed from the local PDF metadata and abstract

## One-Sentence Summary

This skim note records a linear blind unmixing, diffusion, graph, ADMM paper and tracks its reported evaluation on Urban; synthetic.
...
- Main idea: linear blind unmixing; diffusion; graph; ADMM.
